export const logicalEndPrompt = (userInput, nodesPromise, flow_start, messages, language): string => {
    ...
    Once that has been established that the user wants to end the conversation, return with a generic concluding message thanking the user for contacting. Eensure that the message is in the "${language}" that is being passed
